...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      backgroundColor: const Color.fromARGB(255, 191, 130, 231), // ✅ ใส่ตรงนี้
      appBar: AppBar(
        title: const Text('หน้าแรก'),
        backgroundColor: const Color.fromARGB(255, 155, 43, 189),
        foregroundColor: Colors.white, // ✅ สีไอคอน + ข้อความ
      ),

      // 🔹 Drawer = เมนูด้านข้าง (เลื่อนจากซ้าย)
      drawer: Drawer(
        backgroundColor: const Color.fromARGB(255, 252, 217, 165),
        child: ListView(
